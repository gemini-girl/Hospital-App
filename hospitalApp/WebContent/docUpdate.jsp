        ...
        <div class="post"> <a name="TemplateInfo"></a>
          <p><center>      
              ...
              if (list!= null && !list.isEmpty()){
                 ...
                 while(r.next()){ %>
             <form name = "myform" onsubmit="return validation();" action = "docUp.jsp">
             <p>Doctor Name: <%= r.getString("dname")%>
             <p>Patient Name:<input style="margin-right:30px;margin-left:30px" name = "pname" id = "pname" type = "text" value = "<%= r.getString("pname")%>"></input>
  			 <p>Medical Description: <input style="margin-right:30px;margin-left:30px" name = "description" id = "description" type = "text" value = "<%= r.getString("description")%>"></input> 	
  			 <p>Fees:<input style="margin-right:30px;margin-left:30px" name = "fees" id = "fees" type = "text" value = "<%= r.getString("fees")%>"></input>
  			 <p>Address :<input style="margin-right:30px;margin-left:30px" name = "address" id = "address" type = "text" value = "<%= r.getString("address")%>"></input>
